            ...
            <article className='main-projects--project grid'>
                    ...
                    <section className='project-info grid'>
                        <div className='project-info--description grid'>
                            <h4>Description</h4>
                            <p>My most recent project (and current work in progress) is the creation of this full-stack Spotify clone app. What I like most about the Spotify app is the design and ease of use for the consumer. As such, I wanted to remain truthful to this design in my own approach, whilst also implementing a few subtle changes to add my own flair. <br /> In order to achieve this I have utilised the Spotify Web API to create an app with the core functionality, allowing a user to play/pause a track, skip forward/backwards and change/mute the volume. I have also implemented a search feature and the details for every artist/album/playlist can be viewed throughout the app. The user&apos;s own playlists, saved albums and liked tracks are available in the left side menu. <br /> A particular feature of the Spotify app I like is the use of the album artwork colours to generate a gradient background. I have also implemented this feature into my own app to mix the predominant colours of an album artwork and use the result to dynamically render a gradient along with the core background colour. <br />Regarding the backend aspect of this app, I have implemented a login feature for added security. </p>
                        </div>
